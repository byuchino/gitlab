"""
Find and tag all malicious Attack Analyzer result artifacts.
"""
...
def filter_by_provider(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    matched_artifacts_1, matched_results_1 = phantom.condition(
        ...
        conditions=[
            ["artifact:*.cef.provider", "==", "splunk attack analyzer"],
            ["artifact:*.cef.ioc", "!=", ""],
            ["artifact:*.cef.jobid", "!=", ""],
            ["artifact:*.cef.Score", "!=", ""]
        ],
    ...
    if matched_artifacts_1 or matched_results_1:
        aa_check_if_malicious(action=action, success=success, container=container, results=results, handle=handle, filtered_artifacts=matched_artifacts_1, filtered_results=matched_results_1)

    return


@phantom.playbook_block()
def aa_check_if_malicious(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("aa_check_if_malicious() called")

    # collect filtered artifact ids and results for 'if' condition 1
    matched_artifacts_1, matched_results_1 = phantom.condition(
        container=container,
        conditions=[
            ["filtered-data:filter_by_provider:condition_1:artifact:*.cef.Score", ">=", 80]
        ],
        name="aa_check_if_malicious:condition_1",
        delimiter=None)
    ...
    matched_artifacts_2, matched_results_2 = phantom.condition(
        ...
        name="aa_check_if_malicious:condition_2",
        delimiter=None)
...
def playbook_update_artifact_tags__utility__1(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    filtered_artifact_0_data_aa_check_if_malicious = phantom.collect2(container=container, datapath=["filtered-data:aa_check_if_malicious:condition_1:artifact:*.id"])

    filtered_artifact_0__id = [item[0] for item in filtered_artifact_0_data_aa_check_if_malicious]
...
def playbook_update_artifact_tags__utility__2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    filtered_artifact_0_data_aa_check_if_malicious = phantom.collect2(container=container, datapath=["filtered-data:aa_check_if_malicious:condition_2:artifact:*.id"])
    ...
    # call playbook "phantom_pb_templates/Update Artifact Tags [Utility]", returns the playbook_run_id
    playbook_run_id = phantom.playbook("phantom_pb_templates/Update Artifact Tags [Utility]", container=container, inputs=inputs)
