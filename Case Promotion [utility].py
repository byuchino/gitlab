...
def compose_report(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    ...
    add_comment_promote_to_case_add_note_2(container=container)

    return


def add_comment_promote_to_case_add_note_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, **kwargs):
    phantom.debug("add_comment_promote_to_case_add_note_2() called")
    ...
    phantom.comment(container=container, comment="Promote to Case")
