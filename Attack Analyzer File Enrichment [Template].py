"""
Submit vault ID(s) to Attack Analyzer for detonation.  Store detonation job ID(s) from response in new artifact(s) for later processing and tag the container with &quot;saa_job_wait&quot;
"""
...
def on_start(container):
    ...
    # call 'vault_ids_only_filter' block
    vault_ids_only_filter(container=container)

    return

@phantom.playbook_block()
def attack_analyzer_detonate_file(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("attack_analyzer_detonate_file() called")
    ...
    # build parameters list for 'attack_analyzer_detonate_file' call
    for merge_into_single_list__result_item in merge_into_single_list__result:
        if merge_into_single_list__result_item[0] is not None:
            parameters.append({
                "file": merge_into_single_list__result_item[0],
            })
    ...
    phantom.act("detonate file", parameters=parameters, name="attack_analyzer_detonate_file", assets=["saa_asset"], callback=check_status)

    return


@phantom.playbook_block()
def vault_ids_only_filter(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    phantom.debug("vault_ids_only_filter() called")
    ...
    matched_artifacts_1, matched_results_1 = phantom.condition(
        ...
        name="vault_ids_only_filter:condition_1",
        delimiter=None)
...
def merge_into_single_list(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    filtered_artifact_0_data_vault_ids_only_filter = phantom.collect2(container=container, datapath=["filtered-data:vault_ids_only_filter:condition_1:artifact:*.cef.vaultId","filtered-data:vault_ids_only_filter:condition_1:artifact:*.cef.vault_id","filtered-data:vault_ids_only_filter:condition_1:artifact:*.id"])

    filtered_artifact_0__cef_vaultid = [item[0] for item in filtered_artifact_0_data_vault_ids_only_filter]
    filtered_artifact_0__cef_vault_id = [item[1] for item in filtered_artifact_0_data_vault_ids_only_filter]

    parameters = []

    parameters.append({
        "input_1": filtered_artifact_0__cef_vaultid,
        "input_2": filtered_artifact_0__cef_vault_id,
        "input_3": None,
        "input_4": None,
        "input_5": None,
        "input_6": None,
    ...
    phantom.custom_function(custom_function="community/list_merge", parameters=parameters, name="merge_into_single_list", callback=attack_analyzer_detonate_file)
...
def check_status(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    matched_artifacts_1, matched_results_1 = phantom.condition(
        container=container,
        conditions=[
            ["attack_analyzer_detonate_file:action_result.status", "==", "success"]
        ],
...
def artifact_create_2(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    for format_artifact_json__item in format_artifact_json__as_list:
        parameters.append({
            "name": "attack analyzer file detonation",
            "tags": "saa_pending",
            "label": None,
            "severity": None,
            "cef_field": None,
...
def format_detonate_failure_note(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    parameters = [
        "filtered-data:check_status:condition_2:attack_analyzer_detonate_file:action_result.parameter.file",
        "filtered-data:check_status:condition_2:attack_analyzer_detonate_file:action_result.message"
    ]
...
def format_artifact_json(action=None, success=None, container=None, results=None, handle=None, filtered_artifacts=None, filtered_results=None, custom_function=None, loop_state_json=None, **kwargs):
    ...
    template = """%%\n{{\"cef_data\":{{\"ioc\":\"{0}\",\"ioctype\":\"file\",\"provider\":\"splunk attack analyzer\",\"jobid\":\"{1}\"}}}}\n%%"""

    # parameter list for template variable replacement
    parameters = [
        "filtered-data:check_status:condition_1:attack_analyzer_detonate_file:action_result.parameter.file",
        "filtered-data:check_status:condition_1:attack_analyzer_detonate_file:action_result.data.*.JobID"
    ]
